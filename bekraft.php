...
<HTML xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US">
 ...
 <center>               
 <form action="emailTilfoj.php" method="post" id = "frem">
                <?php
                        // connect to the database
                        
                        // get the records from the database
                        if ($result = $mysqli->query("select * from deltagerinfo natural join deltagerinfoloeb"))
                        {
                ...
                ?>
						<input type="submit" value = "N&aelig;ste" style="width:190px;" id = "frem";>
					</form>
<!--					<form action="TilfoejDeltager.php" method="post" id = "tilbage">
					<input type="submit" value = "Tilbage" id = "tilbage">
					</form> -->
